      ...
      <div className="modal gs-modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 560 }}>
          ...
          <div className="modal-form">
            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start', paddingTop: 4 }}>
              ...
              <label htmlFor="terms" style={{ fontSize: 12, color: 'var(--muted)', lineHeight: 1.5, cursor: 'pointer' }}>
                I agree to AgroOS's <span style={{ color: 'var(--g)', fontWeight: 600 }}>Terms of Service</span> and <span style={{ color: 'var(--g)', fontWeight: 600 }}>Privacy Policy</span>. I understand my data is processed within the Moolre ecosystem.
              </label>
            </div>
        ...
        {step === 2 && (
          <div style={{ textAlign: 'center', padding: '8px 0 4px' }}>
            ...
            <div style={{ display: 'flex', gap: 10, justifyContent: 'center' }}>
              <button className="btn-out-lg" style={{ fontSize: 13, padding: '10px 22px' }} onClick={onClose}>Back to site</button>
              <button className="btn-lg" style={{ fontSize: 13, padding: '10px 22px' }} onClick={onLogin}>Go to dashboard →</button>
            </div>
        ...
        {step < 2 && (
          <div style={{ textAlign: 'center', marginTop: 16, fontSize: 12, color: 'var(--muted)' }}>
            ...
            <button onClick={onLogin} style={{ background: 'none', border: 'none', color: 'var(--g)', fontWeight: 600, fontSize: 12, cursor: 'pointer', fontFamily: 'inherit' }}>
              Sign in
            </button>
          </div>
        )}
