...
export default function Footer({ setPage, onGetStarted }) {
  return (
    <footer className="footer">
      <div className="footer-grid">
        ...
        <div>
          ...
          <a href="#" className="footer-link" onClick={(e) => { e.preventDefault(); if (onGetStarted) onGetStarted() }}>Request access</a>
          <a href="#" className="footer-link" onClick={(e) => { e.preventDefault(); setPage('book-demo') }}>Book a demo</a>
